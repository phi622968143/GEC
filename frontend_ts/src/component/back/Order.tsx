...
// Define types for orders, order details, and product details
interface Order {
  id: number;
...
const Order: React.FC = () => {
  ...
  const [expandedOrderId, setExpandedOrderId] = useState<number | null>(null); // Tracks which order is expanded
  ...
  const handleShowMoreClick = (orderId: number) => {
